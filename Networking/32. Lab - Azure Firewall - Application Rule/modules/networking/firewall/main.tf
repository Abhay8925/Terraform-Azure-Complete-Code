...
resource "azurerm_firewall_policy_rule_collection_group" "rulecollection" {
  ...
  nat_rule_collection {
    ...
    dynamic rule {
      ...
      translated_address  = var.network_interface_ipaddresses[rule.key].private_ip_address
      translated_port     = "22"
      }
    }
  }
  ...
  application_rule_collection {
    ...
    dynamic rule {
      ...
      source_addresses  = [var.network_interface_ipaddresses[rule.key].private_ip_address]
